...
<form action="addLecture">
    <div class="lecture-form">
        <div class="lecture-form__group">
            ...
            <input type="text" name="NewLecture.LectureName" class="lecture-input" placeholder="Create new Lecture...">
            <input type="text" name="NewLecture.CourseId" class="lecture-input" value="${value_cid}" hidden>
        </div>
        <div class="lecture-form__group">
            <label for="" class="lecture-lable">Description</label><br>
            <textarea name="NewLecture.Description" cols="62" class="lecture-textar"
                rows="8"></textarea>
        </div>
        <div class="lecture-form__group">
